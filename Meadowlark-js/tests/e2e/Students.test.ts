...
describe('Students', () => {
  ...
  // it('should allow invalid country for token without strict validation', () => {
  //   sharedFunctions.baseURLRequest
  //     .post('/v3.3b/ed-fi/students')
  //     .auth(sharedFunctions.accessToken, {type: 'bearer'})
  //     .send({
  //       "studentUniqueId": sharedFunctions.generateRandomId(),
  //       "firstName": "First",
  //       "lastSurname": "Last",
  //       "birthDate": "2001-01-01",
  //       "birthCountryDescriptor": "uri://ed-fi.org/CountryDescriptor#AD3"
